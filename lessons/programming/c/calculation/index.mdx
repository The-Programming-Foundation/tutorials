...
<CodeLabLayout title="CLanguageCalculation">
...
<Note>The == operator checks whether <b>a is equal to b</b>. However, the <b>!=</b> operator checks whether <b>a is not equal to b</b>. Therefore, they are called binary operators since they either return <b>true</b> or <b>false</b>.</Note>
