...
## Breaking the loop
- **Break statement** - Break out of the loop by using a break keyword; This caused the execution to move out of the loop and executes the next statement following the loop code.
```Python
