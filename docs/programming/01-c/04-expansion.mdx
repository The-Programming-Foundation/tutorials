...
:::note
To avoid infinite looping, ensure that the conditions given for the loop are
validated at some point. This will stop the loop once the condition is false.
:::
...
:::note
The void function named <b>add()</b> doesn’t have any return value.
:::
