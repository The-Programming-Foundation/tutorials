...
The built-in **open()** function opens and gains access to a file. It accesses a file by the specified filename (in the current directory) or a path to that file.
...
**writelines("a list of strings are specified")**: write multiple strings, each string as a line, into a file.<br />
...
#### The content in shopping_memo.txt after execution:
